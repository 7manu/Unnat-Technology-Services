  ...
  <form action="backend/admin_action.php" method="post" enctype="multipart/form-data">
    ...
    <div class="admin-card">
      ...
      <div class="admin-form-grid">
        ...
        <div class="admin-field"><label for="cover_image">Cover image — path</label><input id="cover_image" name="cover_image" type="text" value="<?= e((string) $form['cover_image']) ?>" placeholder="assets/uploads/cover.webp" /></div>
        ...
        <div class="admin-field"><label for="template">Layout template</label><?= admin_select('template', ['standard' => 'Standard — cover image above the content', 'wide' => 'Wide — full-width content, no cover', 'landing' => 'Landing — cover plus closing call to action'], (string) $form['template'], 'template') ?></div>
